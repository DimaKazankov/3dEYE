...
public class ExternalMergeSorter(ExternalMergeSorterOptions options)
{
    ...
    private readonly ExternalMergeSorterOptions _options = options ?? throw new ArgumentNullException(nameof(options));
